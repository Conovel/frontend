...
| [**getViewedNovelsByMe**](#getviewednovelsbyme) | **GET** /users/me/viewed_novels        | 自分自身が閲覧している小説リストを取得         |
| [**updateUserByMe**](#updateuserbyme)           | **POST** /users/me/update              | 自分自身のユーザーアカウント情報を更新         |
