...
export const MainPanel: React.FC<MainPanelProps> = memo(
  ({
    mainPanel,
    onPostSuccess,
    ...
    const handlePostSubmit = useCallback(
      async (sentenceRequest: PostSentence) => {
        try {
          setError(null);
    ...
    const handleEditPostOpen = useCallback(() => {
      setIsEditPostOpen(true);
    }, []);

    const handleEditPostClose = useCallback(() => {
    ...
    return (
      ...
      >
        <NovelCard
          ...
          onPostClick={handleEditPostOpen}
        />
        <EditPost
          open={isEditPostOpen}
          onClose={handleEditPostClose}
          onSubmit={handlePostSubmit}
          mainText={mainPanel.sentence}
          parentSentenceId={mainPanel.sentence_id}
          parentUpdatedAt={mainPanel.updated_at}
        />
        <Snackbar
          open={!!error}
