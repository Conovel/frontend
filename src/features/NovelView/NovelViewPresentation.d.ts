...
interface NovelViewPresentationProps {
    ...
    setEvaluation_good_count_children: React.Dispatch<React.SetStateAction<number>>;
    ...
    setEvaluation_stay_count_children: React.Dispatch<React.SetStateAction<number>>;
